...
export default {
  ...
  data() {
    return {
      ...
      fields: [
        {
          key: 'Request ID', label: 'Request ID', sortable: true, sortDirection: 'desc',
        },
        {
          key: 'UserName', label: 'User Name', sortable: true, class: 'text-center',
        },
        {
          key: 'PhoneNo', label: 'Phone Number', sortable: true, class: 'text-center',
        },
        {
          key: 'Pickup', label: 'Pickup', sortable: true, class: 'text-center',
        },
        {
          key: 'Missed Ride Type', label: 'Missed Ride  Type', sortable: true, class: 'text-center',
        },
        {
